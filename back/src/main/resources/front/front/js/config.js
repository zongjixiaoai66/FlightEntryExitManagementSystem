...
var centerMenu = [
    ...
    ,{
        name: '起飞降落请求',
        url: '../hangbanYuyue/list.html'
    }
    ,{
        name: '塔台指令',
        url: '../zhiling/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '航班信息',
        url: './pages/hangban/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/hangbanjinchugangguanlixitong/admin/dist/index.html#/login";
